...
* **Synthetic Data Generation:** To create a more robust 5-star distribution, the original **Response** column was updated using the `RANDBETWEEN(1,5)` function. This provided a realistic bell curve for sentiment analysis. Since this project is using sample data and is meant for learning purposes, So methodology is justififed.
