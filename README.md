...
2.  Download the `HR Employee Survey Responses (cleaned).csv` file.
3.  Open the Power Query Editor and place the full file path name of the CSV file in the Source.
